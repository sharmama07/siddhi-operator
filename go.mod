module github.com/siddhi-io/siddhi-operator
...
require (
	...
	github.com/nats-io/nats-operator v0.5.0
	github.com/operator-framework/operator-sdk v0.6.1-0.20190328004606-147862c0001d
...
require (
	...
	github.com/emicklei/go-restful v2.9.2+incompatible // indirect
